...
with tabs[2]:
    ...
    if not has("dem_path") or not has("control_point"):
        ...
        cp = st.session_state["control_point"]
        st.markdown(
            "<div class='hs-info'><b>QA cuenca v3.8.0:</b> además del ajuste puntual al cauce DEM, la app puede usar "
        ...
        st.info(
            "QA v3.8.0 activo: la app corrige el punto al cauce DEM, evalúa candidatos, descarta cuencas truncadas por borde/NoData "
